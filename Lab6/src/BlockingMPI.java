...
public class BlockingMPI {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int rowsCount = matrixA.getRowsNumber();
            int columnsCount = matrixB.getColumnsNumber();
            Matrix resultMatrix = new Matrix(rowsCount, columnsCount, false);
    ...
    private static void masterProcess(Matrix matrix1, Matrix matrix2, Matrix resultMatrix, int workers) {
        ...
        for (int i = 1; i <= workers; i++) {
            ...
            Matrix subMatrix1 = matrix1.sliceMatrix(startRowIndex, endRowIndex, resultMatrix.getColumnsNumber());
        ...
        for (int i = 1; i <= workers; i++) {
            ...
            int countElemsResultBuffer = (endRowIndex[0] - startRowIndex[0] + 1) * resultMatrix.getColumnsNumber() * Integer.BYTES;
            ...
            Matrix subMatrix = Matrix.fromIntArray(resultMatrixBuffer,
                    endRowIndex[0] - startRowIndex[0] + 1, resultMatrix.getColumnsNumber());

            resultMatrix.changeSlice(subMatrix, startRowIndex[0], endRowIndex[0], resultMatrix.getColumnsNumber());
        }
    }
}